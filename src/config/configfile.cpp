...
ConfigFile::ConfigFile(char *argv0, bool readonly) : noWriteAccess(readonly)
{
	...
	configList.push_back(ConfigInfo("StartCash", CONFIG_TYPE_INT, "10000"));
	configList.push_back(ConfigInfo("FirstSmallBlind", CONFIG_TYPE_INT, "50"));
	...
	configList.push_back(ConfigInfo("RaiseSmallBlindEveryHands", CONFIG_TYPE_INT, "11"));
	...
	configList.push_back(ConfigInfo("NetStartCash", CONFIG_TYPE_INT, "10000"));
	configList.push_back(ConfigInfo("NetFirstSmallBlind", CONFIG_TYPE_INT, "50"));
	...
	configList.push_back(ConfigInfo("NetRaiseSmallBlindEveryHands", CONFIG_TYPE_INT, "11"));
	...
	configList.push_back(ConfigInfo("NetDelayBetweenHands", CONFIG_TYPE_INT, "5"));
	configList.push_back(ConfigInfo("NetTimeOutPlayerAction", CONFIG_TYPE_INT, "5"));
